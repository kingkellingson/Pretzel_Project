...
public class OneChangeOnlyAdditionAddToTensResult {
    ...
    public static void main(String[] args) {
        ...
        for (int j = 0; j < 10; ++j) {
            ...
            for (int k = 0; k < 10; ++k) {
                ...
                int result = j + k;
                checkChanges(toAddTo, toTakeFrom, result, 2, numsInEquation);

                ArrayList<String[]> onPage = new ArrayList<>();
                BuildEquation(j, k, result, -1, onPage);
                ...
                for (int l = 0; l < 4; ++l) {
                    for (int m = 0; m < 4; ++m) {
                        ...
                        if (toAddTo[l] != -1 && toTakeFrom[m] != -1) {
                            ...
                            BuildEquation(changedNumsInEquation[0], changedNumsInEquation[1], changedNumsInEquation[2], changedNumsInEquation[3], onPage);
    ...
    private static void BuildEquation(int int1, int int2, int result, int result2, ArrayList<String[]> onPage) {
